...
//go:generate mockgen -package handler_test -source utils_test.go -aux_files github.com/Staffbase/tusd/v2/pkg/handler=datastore.go -destination=handler_mock_test.go
